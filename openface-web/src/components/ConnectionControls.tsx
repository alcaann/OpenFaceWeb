...
export function ConnectionControls({
  ...
  return (
    <div className="my-5 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
      <h3 className="mb-4 text-lg font-semibold text-gray-800 dark:text-gray-200">Connection Settings</h3>
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        <label className="min-w-[100px] font-medium text-gray-700 dark:text-gray-300">Server URL:</label>
        <input
          type="text"
          value={serverUrl}
          onChange={(e) => onServerUrlChange(e.target.value)}
          className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
